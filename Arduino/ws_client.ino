...
const char* ssid = "FamiliaBC"; // Nome da rede
const char* password = "Edguarita"; // Senha da rede
const char* websockets_server_host = "192.168.0.101"; // IP do servidor websocket
